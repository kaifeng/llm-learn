...
提示工程更像是一门艺术和实验科学，而非精确的理论科学。它的核心目标是找到能够让模型最准确、最有效地理解我们意图的咒语。通过与模型进行清晰、结构化的沟通，可以引导这些强大的工具完成日益复杂的任务。
...
除了设计提示词本身，我们还可以通过调整模型的生成参数来精细地控制输出结果。这些参数通常在调用模型 API 时设置。
